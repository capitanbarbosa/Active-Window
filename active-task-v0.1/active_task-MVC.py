...
class NotionView:
    def __init__(self, master):
        ...
        self.overrideredirect_enabled = True  # Define and initialize the attribute
        self.master.geometry("1050x70+0+1373")
        width = self.master.winfo_screenwidth()

        # Create the input box with 90% width
        self.input_box = tk.Text(
            self.master, height=1.5, width=int(
        ...
        self.a3_button.pack(side='right', fill='y', padx=5, pady=0)
        ...
        self.a4_button.pack(side='right', fill='y', padx=5, pady=0)

    def show_result(self):
        if not self.notion.results:
